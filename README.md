...
A **FastAPI-based service** that pulls Apple Watch health metrics and loads them into MinIO and DuckDB for analysis. Steps, heart rate, workouts, sleep — all queryable via SQL instead of locked inside the Health app.
